from frontEnd.label_trans import keyword_search
from frontEnd.photohash import hash_distance, average_hash
...
class Pick_image():
    def __init__(self) -> None:
        ...
        self.labels = {}
        labelListfile = open('frontEnd/assets/labelList.txt', 'r', encoding="utf-8")
        ...
        self.images = {}
        imageListfile = open('frontEnd/assets/imageList.txt', 'r', encoding="utf-8")
